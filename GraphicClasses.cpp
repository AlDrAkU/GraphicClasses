...
const std::string g_WindowTitle{ "Project GraphicClasses - Bouros, Razvan - 1DAE06" };
...
//
//	Rectf rectangle1;
//	rectangle1.left = 10; // border
//	rectangle1.bottom = g_WindowHeight - 10 - 30;
//	rectangle1.height = g_WindowHeight - 10;
//	rectangle1.width = 10 + 20;
//	DrawRect(rectangle1, 2);
//
//
//}
